...
router.get('/cart', isAdmin, cart.getCartItems); //DONE PASS REFACTOR - plural
router.post('/cart', loggedIn, cart.createCartItem); 
router.get('/cart/:id', isAdmin, cart.getCartItemById); //DONE PASS REFACTOR -  ITem
router.put('/cart/:id', isAdmin, cart.updateCartItem);
router.delete('/cart/:id', isAdmin, cart.deleteCartItem);
router.get('/cart/order/:id', isAdmin, cart.getCartByOrderId); //DONE PASS REFACTOR - remove item
